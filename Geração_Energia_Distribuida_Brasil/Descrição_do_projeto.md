...
1. Preparação, Limpeza e Tratamento dos Dados na Linguagem Python (Jupyter Notebook):
...
2. Análise e Modelagem de Dados no PostgreSQL
...
3. Criação de Dashboards no Power BI
